...
### Nota que propongo: 4.2

### Justificación:

#### 1. Investigación y Experimentación (Evidencia en Actividad 2)  Nota: 4
No llego al nivel “Excelente” porque aunque explico bien qué hace cada parte y por qué, la interrelación del tema podría ser sido más profunda. Pero por lo menos mis explicaciones y modificaciones cumplen lo pedido.

#### 2. Intención y Diseño (Proceso de Actividad 3)  Nota: 4.4
Concidero que podria llegar a ser más claro con mi obra y tambien debi haber echo un proceso de diseño más exhaustivo, en donde no me quedara con mi primera idea, sin embargpo dicha idea era la mejor intencionada para reflejar mis pensamientos.

#### 3. Aplicación Técnica (Código de Actividad 3)  Nota: 4.2
Pienso que me faltaria pulir más mi codigo pues aunque funcione, seguramente es muy redundante y muy poco optimizado, sin embargo este mismo implementa los temas de las unidades y cumple con lo descrito en la guia de diseño.
